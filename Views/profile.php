                    ...
                    <div class="modal fade" id="js-modal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="profile.php" method="post" enctype="multipart/dorm-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="password" class="form-control mb-4" name="password" value="" placeholder="パスワードを変更をする場合ご入力ください" minlength="4" maxlength="128">
                                    </div>
